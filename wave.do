...
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/test_Update_filter_signal
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/test_Update_spike_signal
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/PE_operation
add wave -noupdate -radix unsigned /testbench_NoC/PE1/decoder_PE/PE_operation
...
add wave -noupdate -radix unsigned -childformat {{{/testbench_NoC/PE1/pe_v2/Filter_mem/mem[2]} -radix unsigned} {{/testbench_NoC/PE1/pe_v2/Filter_mem/mem[1]} -radix unsigned} {{/testbench_NoC/PE1/pe_v2/Filter_mem/mem[0]} -radix unsigned}} -expand -subitemconfig {{/testbench_NoC/PE1/pe_v2/Filter_mem/mem[2]} {-height 15 -radix unsigned} {/testbench_NoC/PE1/pe_v2/Filter_mem/mem[1]} {-height 15 -radix unsigned} {/testbench_NoC/PE1/pe_v2/Filter_mem/mem[0]} {-height 15 -radix unsigned}} /testbench_NoC/PE1/pe_v2/Filter_mem/mem
add wave -noupdate -radix unsigned -childformat {{{/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[4]} -radix unsigned} {{/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[3]} -radix unsigned} {{/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[2]} -radix unsigned} {{/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[1]} -radix unsigned} {{/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[0]} -radix unsigned}} -expand -subitemconfig {{/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[4]} {-height 15 -radix unsigned} {/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[3]} {-height 15 -radix unsigned} {/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[2]} {-height 15 -radix unsigned} {/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[1]} {-height 15 -radix unsigned} {/testbench_NoC/PE1/pe_v2/Ifmap_mem/mem[0]} {-height 15 -radix unsigned}} /testbench_NoC/PE1/pe_v2/Ifmap_mem/mem
...
add wave -noupdate -radix unsigned /testbench_NoC/PE0/pe_v2/Mulitiplier/mulit_value
add wave -noupdate -radix unsigned /testbench_NoC/PE0/pe_v2/Split/Input_value
add wave -noupdate -radix unsigned /testbench_NoC/PE1/pe_v2/Mulitiplier/in_value_0
add wave -noupdate -radix unsigned /testbench_NoC/PE1/pe_v2/Mulitiplier/in_value_1
add wave -noupdate -radix unsigned /testbench_NoC/PE1/pe_v2/Mulitiplier/mulit_value
add wave -noupdate -radix unsigned /testbench_NoC/PE1/pe_v2/Filter_mem/in_Read_addr_value
add wave -noupdate -radix unsigned /testbench_NoC/PE1/pe_v2/Ifmap_mem/in_Read_addr_value
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {25319095 fs} 0}
...
update
WaveRestoreZoom {0 fs} {156941152 fs}
