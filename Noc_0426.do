...
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/IN_filter_frame_value
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/IN_spike_frame_value
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/receive_count
...
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/test_Update_filter_signal
add wave -noupdate -radix unsigned /testbench_NoC/PE0/decoder_PE/test_Update_spike_signal
add wave -noupdate -radix unsigned /testbench_NoC/PE0/Encoder_PE/Encoder_count
add wave -noupdate -radix unsigned /testbench_NoC/PE0/Encoder_PE/TEST_Encoder_count_send_req
...
add wave -noupdate -radix unsigned /testbench_NoC/PE1/Encoder_PE/Encoder_count
add wave -noupdate -radix unsigned /testbench_NoC/PE1/Encoder_PE/TEST_Encoder_count_send_req
add wave -noupdate -radix unsigned /testbench_NoC/PE1/decoder_PE/test_Update_filter_signal
add wave -noupdate -radix unsigned /testbench_NoC/PE1/decoder_PE/test_Update_spike_signal
...
add wave -noupdate /testbench_NoC/MEM/smw_DUT/IN_PE_source_addr_value
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {943505361 fs} 0}
